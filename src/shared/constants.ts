...
export const roleDefs: Array<{ key: Role; label: string; stages: string[] }> = [
  ...
  { key: "printer", label: "Printer", stages: ["Printing"] },
...
export const users: User[] = [
  ...
  { id: "rafael", name: "Rafael Torres", role: "printer", initials: "RT", dept: "Printing" },
  { id: "liza", name: "Liza Ramos", role: "printer", initials: "LR", dept: "Printing" },
